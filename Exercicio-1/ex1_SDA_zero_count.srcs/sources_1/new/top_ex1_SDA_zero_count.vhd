...
-- 
-- Create Date: 19.09.2020 22:58:24
-- Design Name: 
-- Module Name: top_ex1_SDA_zero_count - Behavioral
-- Project Name: SDA - Lista de exercícios 1
-- Target Devices: Artix 7 - Basys 3
-- Tool Versions: Vivado 2018.3
-- Description: 
-- 
-- Arquivo top module que conecta 1º exercício da lista de xercícios 1 de SDA
...
entity top_ex1_SDA_zero_count is
    ...
    Port ( 
            ...
            -- VIO IP core.
            --
            -- Entrada de clk. O circuito ex1_SDA_zero_count é puramente combinacional,
...
end top_ex1_SDA_zero_count;

-- Arquitetura: descrição do funcionamento do sistema
architecture Behavioral of top_ex1_SDA_zero_count is

    -- Declarando ex1_SDA_zero_count como componente 
...
begin
    ...
    ZERO_COUNT_MODULE: ex1_SDA_zero_count 
